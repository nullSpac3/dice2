...
function whoWon() {
    ...
    currBalance = "Current Balance = $" + balance;
    // Report the outcome:
    banner = die1 + " + " + die2 + " is: " + dieSum;
    document.querySelector("h3").innerHTML = banner + "<br>" + outcome + "<br><br>" + currBalance;
    
}


function letsPlay(){
  var diceRolls = prompt("How many times do you want to roll?");
  currBalance = 0;
  balance = 0;
